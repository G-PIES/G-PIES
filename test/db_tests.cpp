...
TEST_F(ClientDbTest, NuclearReactorCRUD) {
    ...
    ASSERT_EQ(reactor.get_dislocation_density_evolution(),
              reactor_cpy.get_dislocation_density_evolution());
    ...
    ASSERT_THROW(db.read_reactor(-1, reactor_cpy, &sqlite_code),
                 ClientDbException);
    ...
    reactor_cpy.sqlite_id = -1;
    ASSERT_THROW(db.update_reactor(reactor_cpy, &sqlite_code),
                 ClientDbException);
    ...
    reactor_cpy.sqlite_id = -1;
    ASSERT_THROW(db.delete_reactor(reactor_cpy, &sqlite_code),
                 ClientDbException);
}
...
TEST_F(ClientDbTest, MaterialCRUD) {
    ...
    ASSERT_TRUE(
        db.read_material(material.sqlite_id, material_cpy, &sqlite_code));
    ASSERT_TRUE(db.is_sqlite_success(sqlite_code));
    ...
    ASSERT_EQ(material.get_recombination_radius(),
              material_cpy.get_recombination_radius());
    ASSERT_EQ(material.get_i_loop_bias(), material_cpy.get_i_loop_bias());
    ASSERT_EQ(material.get_i_dislocation_bias(),
              material_cpy.get_i_dislocation_bias());
    ASSERT_EQ(material.get_i_dislocation_bias_param(),
              material_cpy.get_i_dislocation_bias_param());
    ASSERT_EQ(material.get_v_loop_bias(), material_cpy.get_v_loop_bias());
    ASSERT_EQ(material.get_v_dislocation_bias(),
              material_cpy.get_v_dislocation_bias());
    ASSERT_EQ(material.get_v_dislocation_bias_param(),
              material_cpy.get_v_dislocation_bias_param());
    ASSERT_EQ(material.get_dislocation_density_0(),
              material_cpy.get_dislocation_density_0());
    ...
    // read one invalid sql id
    ASSERT_THROW(db.read_material(-1, material_cpy, &sqlite_code),
                 ClientDbException);
    ...
    // update one invalid sql id
    material_cpy.sqlite_id = -1;
    ASSERT_THROW(db.update_material(material_cpy, &sqlite_code),
                 ClientDbException);
    ...
    // delete one invalid sql id
    material_cpy.sqlite_id = -1;
    ASSERT_THROW(db.delete_material(material_cpy, &sqlite_code),
                 ClientDbException);
}
