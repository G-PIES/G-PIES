...
bool ClusterDynamicsImpl::step(gp_float delta_time)
{
    ...
    memcpy(interstitials_in + 1, interstitials.data() + 1, sizeof(gp_float) * concentration_boundary);
    memcpy(vacancies_in + 1, vacancies.data() + 1, sizeof(gp_float) * concentration_boundary);
    ...
    memcpy(interstitials.data() + 2, interstitials_out + 2, sizeof(gp_float) * (concentration_boundary - 1));
    memcpy(vacancies.data() + 2, vacancies_out + 2, sizeof(gp_float) * (concentration_boundary - 1));

    mtl_args.dislocation_density += dislocation_density_derivative() * delta_time;
