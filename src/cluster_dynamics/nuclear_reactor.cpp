...
#include "nuclear_reactor_impl.hpp"
  ...
  gp_float NuclearReactor::get_flux() const
	{
		return _impl->flux;
	}
	...
	void NuclearReactor::set_flux(const gp_float val)
	{
		_impl->flux = val;
	}

  /// @brief Returns the temperature in Kelvin.
  gp_float NuclearReactor::get_temperature() const
	{
  ...
  gp_float NuclearReactor::get_i_bi() const
	{
		return _impl->i_bi;
	}
	...
	void NuclearReactor::set_i_bi(const gp_float val)
	{
		_impl->i_bi = val;
	}

  /// @brief Returns the fraction of generated interstitial clusters which are size 3.
  gp_float NuclearReactor::get_i_tri() const
	{
		return _impl->i_tri;
	}
	...
	void NuclearReactor::set_i_tri(const gp_float val)
	{
		_impl->i_tri = val;
	}

  /// @brief Returns the fraction of generated interstitial clusters which are size 4.
  gp_float NuclearReactor::get_i_quad() const
	{
		return _impl->i_quad;
	}
	...
	void NuclearReactor::set_i_quad(const gp_float val)
	{
		_impl->i_quad = val;
	}

  /// @brief Returns the fraction of generated vacancy clusters which are size 2.
  gp_float NuclearReactor::get_v_bi() const
	{
		return _impl->v_bi;
	}
	...
	void NuclearReactor::set_v_bi(const gp_float val)
	{
		_impl->v_bi = val;
	}

  /// @brief Returns the fraction of generated vacancy clusters which are size 3.
  gp_float NuclearReactor::get_v_tri() const
	{
		return _impl->v_tri;
	}
	...
	void NuclearReactor::set_v_tri(const gp_float val)
	{
		_impl->v_tri = val;
	}

  /// @brief Returns the fraction of generated vacancy clusters which are size 4.
  gp_float NuclearReactor::get_v_quad() const
	{
		return _impl->v_quad;
	}
	...
	void NuclearReactor::set_v_quad(const gp_float val)
	{
		_impl->v_quad = val;
	}
  ...
  NuclearReactorImpl* NuclearReactor::impl()
  {
      return _impl.get();
  }
