 ...
 * 
 * \f$
 * \dwn{G_i(1)=}\ann{1}{\eta} \ann{2}{G_{dpa}}\dwn{(1-}\ann{3}{f_{i3}}\dwn{-}\ann{4}{f_{i4})}\\
 * G_i(2)=0\\
...
/** @brief Returns the combined rate of emission of an interstitial and absorption of a vacancy by an interstitial loop of size (n)
